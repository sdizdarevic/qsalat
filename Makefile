...
# Generated by qmake (2.01a) (Qt 4.5.2) on: Mon Oct 19 11:02:33 2009
# Project:  Qsalat.pro
# Template: app
# Command: /usr/local/Trolltech/Qt-4.5.2/bin/qmake -unix -o Makefile Qsalat.pro
#############################################################################
...
INCPATH       = -I/usr/local/Trolltech/Qt-4.5.2/mkspecs/linux-g++ -I. -I/usr/local/Trolltech/Qt-4.5.2/include/QtCore -I/usr/local/Trolltech/Qt-4.5.2/include/QtNetwork -I/usr/local/Trolltech/Qt-4.5.2/include/QtGui -I/usr/local/Trolltech/Qt-4.5.2/include/QtXml -I/usr/local/Trolltech/Qt-4.5.2/include/phonon -I/usr/local/Trolltech/Qt-4.5.2/include/QtWebKit -I/usr/local/Trolltech/Qt-4.5.2/include -Ibuild -Ibuild
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,/usr/local/Trolltech/Qt-4.5.2/lib
LIBS          = $(SUBLIBS)  -L/usr/local/Trolltech/Qt-4.5.2/lib lib/libphonon.so -L/usr/local/Trolltech/Qt-4.5.2/lib -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -L/usr/X11R6/lib -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread lib/libQtCore.so -pthread lib/libQtGui.so -pthread -pthread -pthread lib/libQtNetwork.so -pthread -pthread lib/libQtWebKit.so -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread lib/libQtXml.so -pthread -pthread -lplugins/imageformats -lplugins/phonon_backend -lQtWebKit -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -lphonon -lQtDBus -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -lQtXml -pthread -pthread -lQtGui -pthread -lpng -lfreetype -lSM -lICE -pthread -pthread -lXrender -lfontconfig -lXext -lX11 -lQtNetwork -pthread -pthread -lQtCore -lz -lm -pthread -lgthread-2.0 -lrt -lglib-2.0 -ldl -lpthread
AR            = ar cqs
RANLIB        = 
...
DIST          = /usr/local/Trolltech/Qt-4.5.2/mkspecs/common/g++.conf \
		...
		/usr/local/Trolltech/Qt-4.5.2/mkspecs/features/release.prf \
...
Makefile: Qsalat.pro  /usr/local/Trolltech/Qt-4.5.2/mkspecs/linux-g++/qmake.conf /usr/local/Trolltech/Qt-4.5.2/mkspecs/common/g++.conf \
		/usr/local/Trolltech/Qt-4.5.2/mkspecs/common/unix.conf \
		/usr/local/Trolltech/Qt-4.5.2/mkspecs/common/linux.conf \
		/usr/local/Trolltech/Qt-4.5.2/mkspecs/qconfig.pri \
		/usr/local/Trolltech/Qt-4.5.2/mkspecs/features/qt_functions.prf \
		...
		/usr/local/Trolltech/Qt-4.5.2/mkspecs/features/lex.prf \
		lib/libphonon.prl \
		/usr/local/Trolltech/Qt-4.5.2/lib/libQtDBus.prl \
		/usr/local/Trolltech/Qt-4.5.2/lib/libQtXml.prl \
		/usr/local/Trolltech/Qt-4.5.2/lib/libQtCore.prl \
		/usr/local/Trolltech/Qt-4.5.2/lib/libQtGui.prl \
		lib/libQtCore.prl \
		lib/libQtGui.prl \
		lib/libQtNetwork.prl \
		lib/libQtWebKit.prl \
		/usr/local/Trolltech/Qt-4.5.2/lib/libphonon.prl \
		/usr/local/Trolltech/Qt-4.5.2/lib/libQtNetwork.prl \
		lib/libQtXml.prl \
		/usr/local/Trolltech/Qt-4.5.2/lib/libQtWebKit.prl
	$(QMAKE) -unix -o Makefile Qsalat.pro
/usr/local/Trolltech/Qt-4.5.2/mkspecs/common/g++.conf:
/usr/local/Trolltech/Qt-4.5.2/mkspecs/common/unix.conf:
/usr/local/Trolltech/Qt-4.5.2/mkspecs/common/linux.conf:
/usr/local/Trolltech/Qt-4.5.2/mkspecs/qconfig.pri:
/usr/local/Trolltech/Qt-4.5.2/mkspecs/features/qt_functions.prf:
...
build/moc_qsalat.cpp: ui_salat.h \
		src/qpray.h \
		src/qhijri.h \
		src/qlocation.h \
		ui_location.h \
		...
		ui_player.h \
		src/qsalat.h
	/usr/local/Trolltech/Qt-4.5.2/bin/moc $(DEFINES) $(INCPATH) src/qsalat.h -o build/moc_qsalat.cpp

build/moc_qqibla.cpp: ui_qibla.h \
		src/domparser.h \
		src/qqibla.h
	/usr/local/Trolltech/Qt-4.5.2/bin/moc $(DEFINES) $(INCPATH) src/qqibla.h -o build/moc_qqibla.cpp

build/moc_qlocation.cpp: ui_location.h \
		src/domparser.h \
		src/qcalculation.h \
		ui_calculation.h \
		src/qpray.h \
		src/qlocation.h
	/usr/local/Trolltech/Qt-4.5.2/bin/moc $(DEFINES) $(INCPATH) src/qlocation.h -o build/moc_qlocation.cpp

build/moc_qaudio.cpp: ui_audio.h \
		src/domparser.h \
		src/qaudio.h
	/usr/local/Trolltech/Qt-4.5.2/bin/moc $(DEFINES) $(INCPATH) src/qaudio.h -o build/moc_qaudio.cpp

build/moc_qmonthly.cpp: ui_monthly.h \
		src/utils.h \
		src/qpray.h \
		src/domparser.h \
		src/qmonthly.h
	/usr/local/Trolltech/Qt-4.5.2/bin/moc $(DEFINES) $(INCPATH) src/qmonthly.h -o build/moc_qmonthly.cpp

build/moc_qyearly.cpp: ui_yearly.h \
		src/utils.h \
		src/qpray.h \
		src/domparser.h \
		src/qyearly.h
	/usr/local/Trolltech/Qt-4.5.2/bin/moc $(DEFINES) $(INCPATH) src/qyearly.h -o build/moc_qyearly.cpp

build/moc_qworldTime.cpp: ui_worldtime.h \
		src/qworldTime.h
	/usr/local/Trolltech/Qt-4.5.2/bin/moc $(DEFINES) $(INCPATH) src/qworldTime.h -o build/moc_qworldTime.cpp

build/moc_qcalculation.cpp: ui_calculation.h \
		src/domparser.h \
		src/qpray.h \
		src/qcalculation.h
	/usr/local/Trolltech/Qt-4.5.2/bin/moc $(DEFINES) $(INCPATH) src/qcalculation.h -o build/moc_qcalculation.cpp

build/moc_qhijridate.cpp: ui_hijri.h \
		src/qhijri.h \
		src/domparser.h \
		src/qhijridate.h
	/usr/local/Trolltech/Qt-4.5.2/bin/moc $(DEFINES) $(INCPATH) src/qhijridate.h -o build/moc_qhijridate.cpp

build/moc_dsingleapplication.cpp: src/dsingleapplication.h
	/usr/local/Trolltech/Qt-4.5.2/bin/moc $(DEFINES) $(INCPATH) src/dsingleapplication.h -o build/moc_dsingleapplication.cpp

build/moc_player.cpp: ui_player.h \
		src/player.h
	/usr/local/Trolltech/Qt-4.5.2/bin/moc $(DEFINES) $(INCPATH) src/player.h -o build/moc_player.cpp
...
qrc_salat.cpp: salat.qrc \
	...
	/usr/local/Trolltech/Qt-4.5.2/bin/rcc -name salat salat.qrc -o qrc_salat.cpp

qrc_qibla.cpp: qibla.qrc \
		/usr/share/qsalat/images/boussole.png
	/usr/local/Trolltech/Qt-4.5.2/bin/rcc -name qibla qibla.qrc -o qrc_qibla.cpp
...
qrc_worldtime.cpp: worldtime.qrc \
	...
	/usr/local/Trolltech/Qt-4.5.2/bin/rcc -name worldtime worldtime.qrc -o qrc_worldtime.cpp
...
build/ui_salat.h: ui/salat.ui
	/usr/local/Trolltech/Qt-4.5.2/bin/uic ui/salat.ui -o build/ui_salat.h

build/ui_qibla.h: ui/qibla.ui
	/usr/local/Trolltech/Qt-4.5.2/bin/uic ui/qibla.ui -o build/ui_qibla.h

build/ui_hijri.h: ui/hijri.ui
	/usr/local/Trolltech/Qt-4.5.2/bin/uic ui/hijri.ui -o build/ui_hijri.h

build/ui_worldtime.h: ui/worldtime.ui
	/usr/local/Trolltech/Qt-4.5.2/bin/uic ui/worldtime.ui -o build/ui_worldtime.h

build/ui_location.h: ui/location.ui
	/usr/local/Trolltech/Qt-4.5.2/bin/uic ui/location.ui -o build/ui_location.h

build/ui_audio.h: ui/audio.ui
	/usr/local/Trolltech/Qt-4.5.2/bin/uic ui/audio.ui -o build/ui_audio.h

build/ui_calculation.h: ui/calculation.ui
	/usr/local/Trolltech/Qt-4.5.2/bin/uic ui/calculation.ui -o build/ui_calculation.h

build/ui_monthly.h: ui/monthly.ui
	/usr/local/Trolltech/Qt-4.5.2/bin/uic ui/monthly.ui -o build/ui_monthly.h

build/ui_yearly.h: ui/yearly.ui
	/usr/local/Trolltech/Qt-4.5.2/bin/uic ui/yearly.ui -o build/ui_yearly.h

build/ui_player.h: ui/player.ui
	/usr/local/Trolltech/Qt-4.5.2/bin/uic ui/player.ui -o build/ui_player.h
