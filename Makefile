...
# Generated by qmake (2.01a) (Qt 4.5.0) on: Tue Apr 21 21:32:41 2009
# Project:  Qsalat.pro
# Template: app
# Command: /usr/local/Trolltech/Qt-4.5.0/bin/qmake -unix -o Makefile Qsalat.pro
#############################################################################
...
INCPATH       = -I/usr/local/Trolltech/Qt-4.5.0/mkspecs/linux-g++ -I. -I/usr/local/Trolltech/Qt-4.5.0/include/QtCore -I/usr/local/Trolltech/Qt-4.5.0/include/QtNetwork -I/usr/local/Trolltech/Qt-4.5.0/include/QtGui -I/usr/local/Trolltech/Qt-4.5.0/include/QtXml -I/usr/local/Trolltech/Qt-4.5.0/include/phonon -I/usr/local/Trolltech/Qt-4.5.0/include/QtWebKit -I/usr/local/Trolltech/Qt-4.5.0/include -Ibuild -Ibuild
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,/usr/local/Trolltech/Qt-4.5.0/lib
LIBS          = $(SUBLIBS)  -L/usr/local/Trolltech/Qt-4.5.0/lib -lQtWebKit -L/usr/local/Trolltech/Qt-4.5.0/lib -L/usr/X11R6/lib -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -lphonon -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -lQtXml -pthread -pthread -lQtGui -pthread -lpng -lfreetype -lSM -lICE -pthread -pthread -lXrender -lfontconfig -lXext -lX11 -lQtNetwork -pthread -pthread -lQtCore -lz -lm -pthread -lgthread-2.0 -lrt -lglib-2.0 -ldl -lpthread
AR            = ar cqs
RANLIB        = 
...
SOURCES       = src/qsalat.cpp \
		...
		src/domparser.cpp \
		src/player.cpp \
		src/video.cpp build/moc_qsalat.cpp \
...
Makefile: Qsalat.pro  /usr/local/Trolltech/Qt-4.5.0/mkspecs/linux-g++/qmake.conf /usr/local/Trolltech/Qt-4.5.0/mkspecs/common/g++.conf \
		/usr/local/Trolltech/Qt-4.5.0/mkspecs/common/unix.conf \
		/usr/local/Trolltech/Qt-4.5.0/mkspecs/common/linux.conf \
		/usr/local/Trolltech/Qt-4.5.0/mkspecs/qconfig.pri \
		/usr/local/Trolltech/Qt-4.5.0/mkspecs/features/qt_functions.prf \
		...
		/usr/local/Trolltech/Qt-4.5.0/mkspecs/features/yacc.prf \
		/usr/local/Trolltech/Qt-4.5.0/mkspecs/features/lex.prf \
		/usr/local/Trolltech/Qt-4.5.0/lib/libQtWebKit.prl \
		/usr/local/Trolltech/Qt-4.5.0/lib/libphonon.prl \
		/usr/local/Trolltech/Qt-4.5.0/lib/libQtGui.prl \
		/usr/local/Trolltech/Qt-4.5.0/lib/libQtCore.prl \
		/usr/local/Trolltech/Qt-4.5.0/lib/libQtNetwork.prl \
		/usr/local/Trolltech/Qt-4.5.0/lib/libQtXml.prl
...
compiler_moc_header_make_all: build/moc_qsalat.cpp build/moc_qqibla.cpp build/moc_qlocation.cpp build/moc_qaudio.cpp build/moc_qmonthly.cpp build/moc_qyearly.cpp build/moc_qworldTime.cpp build/moc_qcalculation.cpp build/moc_qhijridate.cpp build/moc_dsingleapplication.cpp build/moc_player.cpp build/moc_video.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) build/moc_qsalat.cpp build/moc_qqibla.cpp build/moc_qlocation.cpp build/moc_qaudio.cpp build/moc_qmonthly.cpp build/moc_qyearly.cpp build/moc_qworldTime.cpp build/moc_qcalculation.cpp build/moc_qhijridate.cpp build/moc_dsingleapplication.cpp build/moc_player.cpp build/moc_video.cpp
build/moc_qsalat.cpp: build/ui_salat.h \
		...
		build/ui_player.h \
		src/qsalat.h
	/usr/local/Trolltech/Qt-4.5.0/bin/moc $(DEFINES) $(INCPATH) src/qsalat.h -o build/moc_qsalat.cpp

build/moc_qqibla.cpp: build/ui_qibla.h \
		src/domparser.h \
		src/qqibla.h
	/usr/local/Trolltech/Qt-4.5.0/bin/moc $(DEFINES) $(INCPATH) src/qqibla.h -o build/moc_qqibla.cpp
...
build/moc_qlocation.cpp: build/ui_location.h \
		...
		src/qpray.h \
		src/qlocation.h
	/usr/local/Trolltech/Qt-4.5.0/bin/moc $(DEFINES) $(INCPATH) src/qlocation.h -o build/moc_qlocation.cpp

build/moc_qaudio.cpp: build/ui_audio.h \
		src/domparser.h \
		src/qaudio.h
	/usr/local/Trolltech/Qt-4.5.0/bin/moc $(DEFINES) $(INCPATH) src/qaudio.h -o build/moc_qaudio.cpp
...
build/moc_qmonthly.cpp: build/ui_monthly.h \
		...
		src/domparser.h \
		src/qmonthly.h
	/usr/local/Trolltech/Qt-4.5.0/bin/moc $(DEFINES) $(INCPATH) src/qmonthly.h -o build/moc_qmonthly.cpp
...
build/moc_qyearly.cpp: build/ui_yearly.h \
		...
		src/domparser.h \
		src/qyearly.h
	/usr/local/Trolltech/Qt-4.5.0/bin/moc $(DEFINES) $(INCPATH) src/qyearly.h -o build/moc_qyearly.cpp

build/moc_qworldTime.cpp: build/ui_worldtime.h \
		src/qworldTime.h
	/usr/local/Trolltech/Qt-4.5.0/bin/moc $(DEFINES) $(INCPATH) src/qworldTime.h -o build/moc_qworldTime.cpp

build/moc_qcalculation.cpp: build/ui_calculation.h \
		src/domparser.h \
		src/qpray.h \
		src/qcalculation.h
	/usr/local/Trolltech/Qt-4.5.0/bin/moc $(DEFINES) $(INCPATH) src/qcalculation.h -o build/moc_qcalculation.cpp

build/moc_qhijridate.cpp: build/ui_hijri.h \
		src/qhijri.h \
		src/domparser.h \
		src/qhijridate.h
	/usr/local/Trolltech/Qt-4.5.0/bin/moc $(DEFINES) $(INCPATH) src/qhijridate.h -o build/moc_qhijridate.cpp

build/moc_dsingleapplication.cpp: src/dsingleapplication.h
	/usr/local/Trolltech/Qt-4.5.0/bin/moc $(DEFINES) $(INCPATH) src/dsingleapplication.h -o build/moc_dsingleapplication.cpp

build/moc_player.cpp: build/ui_player.h \
		src/player.h
	/usr/local/Trolltech/Qt-4.5.0/bin/moc $(DEFINES) $(INCPATH) src/player.h -o build/moc_player.cpp

build/moc_video.cpp: src/video.h
	/usr/local/Trolltech/Qt-4.5.0/bin/moc $(DEFINES) $(INCPATH) src/video.h -o build/moc_video.cpp
...
qrc_salat.cpp: salat.qrc \
	...
	/usr/local/Trolltech/Qt-4.5.0/bin/rcc -name salat salat.qrc -o qrc_salat.cpp

qrc_qibla.cpp: qibla.qrc \
		/usr/share/qsalat/images/boussole.png
	/usr/local/Trolltech/Qt-4.5.0/bin/rcc -name qibla qibla.qrc -o qrc_qibla.cpp
...
qrc_worldtime.cpp: worldtime.qrc \
	...
	/usr/local/Trolltech/Qt-4.5.0/bin/rcc -name worldtime worldtime.qrc -o qrc_worldtime.cpp
...
build/ui_salat.h: ui/salat.ui
	/usr/local/Trolltech/Qt-4.5.0/bin/uic ui/salat.ui -o build/ui_salat.h

build/ui_qibla.h: ui/qibla.ui
	/usr/local/Trolltech/Qt-4.5.0/bin/uic ui/qibla.ui -o build/ui_qibla.h

build/ui_hijri.h: ui/hijri.ui
	/usr/local/Trolltech/Qt-4.5.0/bin/uic ui/hijri.ui -o build/ui_hijri.h

build/ui_worldtime.h: ui/worldtime.ui
	/usr/local/Trolltech/Qt-4.5.0/bin/uic ui/worldtime.ui -o build/ui_worldtime.h

build/ui_location.h: ui/location.ui
	/usr/local/Trolltech/Qt-4.5.0/bin/uic ui/location.ui -o build/ui_location.h

build/ui_audio.h: ui/audio.ui
	/usr/local/Trolltech/Qt-4.5.0/bin/uic ui/audio.ui -o build/ui_audio.h

build/ui_calculation.h: ui/calculation.ui
	/usr/local/Trolltech/Qt-4.5.0/bin/uic ui/calculation.ui -o build/ui_calculation.h

build/ui_monthly.h: ui/monthly.ui
	/usr/local/Trolltech/Qt-4.5.0/bin/uic ui/monthly.ui -o build/ui_monthly.h

build/ui_yearly.h: ui/yearly.ui
	/usr/local/Trolltech/Qt-4.5.0/bin/uic ui/yearly.ui -o build/ui_yearly.h

build/ui_player.h: ui/player.ui
	/usr/local/Trolltech/Qt-4.5.0/bin/uic ui/player.ui -o build/ui_player.h
...
build/video.o: src/video.cpp src/video.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/video.o src/video.cpp
...
build/moc_video.o: build/moc_video.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_video.o build/moc_video.cpp
