...
# Generated by qmake (2.01a) (Qt 4.6.0) on: Fri Jan 1 01:49:15 2010
# Project:  Qsalat.pro
# Template: app
...
SOURCES       = src/qsalat.cpp \
		...
		src/player.cpp \
		src/getFileInfo.cpp \
		src/jmplayer.cpp build/moc_qsalat.cpp \
...
$(TARGET): build/ui_salat.h build/ui_qibla.h build/ui_hijri.h build/ui_worldtime.h build/ui_location.h build/ui_audio.h build/ui_calculation.h build/ui_monthly.h build/ui_yearly.h build/ui_player.h build/ui_jmplayer.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/Qsalat1.0.0/ && $(COPY_FILE) --parents src/qsalat.h src/utils.h src/qpray.h src/qhijri.h src/qqibla.h src/qlocation.h src/qaudio.h src/qmonthly.h src/qyearly.h src/qworldTime.h src/qcalculation.h src/qhijridate.h src/dsingleapplication.h src/domparser.h src/player.h src/getFileInfo.h src/jmplayer.h build/Qsalat1.0.0/ && $(COPY_FILE) --parents salat.qrc qibla.qrc worldtime.qrc build/Qsalat1.0.0/ && $(COPY_FILE) --parents src/qsalat.cpp src/utils.cpp src/main.cpp src/qpray.cpp src/qhijri.cpp src/qqibla.cpp src/qlocation.cpp src/qaudio.cpp src/qmonthly.cpp src/qyearly.cpp src/qcalculation.cpp src/qworldTime.cpp src/qhijridate.cpp src/dsingleapplication.cpp src/domparser.cpp src/player.cpp src/getFileInfo.cpp src/jmplayer.cpp build/Qsalat1.0.0/ && $(COPY_FILE) --parents ui/salat.ui ui/qibla.ui ui/hijri.ui ui/worldtime.ui ui/location.ui ui/audio.ui ui/calculation.ui ui/monthly.ui ui/yearly.ui ui/player.ui ui/jmplayer.ui build/Qsalat1.0.0/ && $(COPY_FILE) --parents qsalat_en.ts qsalat_fr.ts build/Qsalat1.0.0/ && (cd `dirname build/Qsalat1.0.0` && $(TAR) Qsalat1.0.0.tar Qsalat1.0.0 && $(COMPRESS) Qsalat1.0.0.tar) && $(MOVE) `dirname build/Qsalat1.0.0`/Qsalat1.0.0.tar.gz . && $(DEL_FILE) -r build/Qsalat1.0.0
...
compiler_moc_header_make_all: build/moc_qsalat.cpp build/moc_qqibla.cpp build/moc_qlocation.cpp build/moc_qaudio.cpp build/moc_qmonthly.cpp build/moc_qyearly.cpp build/moc_qworldTime.cpp build/moc_qcalculation.cpp build/moc_qhijridate.cpp build/moc_dsingleapplication.cpp build/moc_player.cpp build/moc_jmplayer.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) build/moc_qsalat.cpp build/moc_qqibla.cpp build/moc_qlocation.cpp build/moc_qaudio.cpp build/moc_qmonthly.cpp build/moc_qyearly.cpp build/moc_qworldTime.cpp build/moc_qcalculation.cpp build/moc_qhijridate.cpp build/moc_dsingleapplication.cpp build/moc_player.cpp build/moc_jmplayer.cpp
...
build/moc_jmplayer.cpp: src/getFileInfo.h \
		build/ui_jmplayer.h \
		src/jmplayer.h
	/usr/local/Trolltech/Qt-4.6.0/bin/moc $(DEFINES) $(INCPATH) src/jmplayer.h -o build/moc_jmplayer.cpp
...
compiler_uic_make_all: build/ui_salat.h build/ui_qibla.h build/ui_hijri.h build/ui_worldtime.h build/ui_location.h build/ui_audio.h build/ui_calculation.h build/ui_monthly.h build/ui_yearly.h build/ui_player.h build/ui_jmplayer.h
compiler_uic_clean:
	-$(DEL_FILE) build/ui_salat.h build/ui_qibla.h build/ui_hijri.h build/ui_worldtime.h build/ui_location.h build/ui_audio.h build/ui_calculation.h build/ui_monthly.h build/ui_yearly.h build/ui_player.h build/ui_jmplayer.h
...
build/ui_jmplayer.h: ui/jmplayer.ui
	/usr/local/Trolltech/Qt-4.6.0/bin/uic ui/jmplayer.ui -o build/ui_jmplayer.h
...
build/getFileInfo.o: src/getFileInfo.cpp src/getFileInfo.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/getFileInfo.o src/getFileInfo.cpp

build/jmplayer.o: src/jmplayer.cpp src/jmplayer.h \
		src/getFileInfo.h \
		build/ui_jmplayer.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/jmplayer.o src/jmplayer.cpp
...
build/moc_jmplayer.o: build/moc_jmplayer.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_jmplayer.o build/moc_jmplayer.cpp
